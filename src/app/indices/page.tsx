...
export default function IndicesPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center text-gray-800">Índices de Desigualdade de Gênero</h1>
        ...
        <Card className="overflow-hidden border-0 bg-gradient-to-br from-blue-50 to-blue-100">
          ...
          <CardContent className="space-y-4 px-6 pb-6">
            ...
            <ul className="list-disc pl-5 text-blue-800">
              <li>Economia: Participação nomercado de trabalho, rendimentos e acesso a recursos econômicos.</li>
